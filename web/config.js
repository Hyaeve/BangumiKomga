...
createApp({
  ...
  methods: {
    ...
    newTask() { this.editingTask = { id: '', name: '', functions: [], fields: [], operations: [], ai_completion: false, include_locked: false, lock_completed: false, card_ids: [], cron: '0 6 * * *', time_limit_hours: 0, enabled: true }; this.$nextTick(() => this.decorateFieldLabels()); },
